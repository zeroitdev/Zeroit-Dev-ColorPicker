    ...
    public class TransparentPanel : Panel
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if(!Circle)
            {
                ...
                {
                    //Smaller Rectangle
                    g.DrawRectangle(new Pen(MiddleColor), new Rectangle(ClientRectangle.X + (Width / 2) - (smallerRectWidth / 2) - 2, ClientRectangle.Y + (Height / 2) - (smallerRectHeight / 2) - 2, smallerRectWidth + 1, smallerRectHeight + 1));
            ...
            else
            {
                ...
                {
                    //Smaller Rectangle
                    //g.DrawEllipse(new Pen(MiddleColor), new Rectangle(ClientRectangle.X + (Width / 2) - (smallerRectWidth / 2) - 2, ClientRectangle.Y + (Height / 2) - (smallerRectHeight / 2) - 2, smallerRectWidth + 1, smallerRectHeight + 1));
