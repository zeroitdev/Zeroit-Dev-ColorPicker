...
namespace ZeroitDevColorPicker.Helpers.Animations
{
    ...
    public class ZeroitAnimator : Component, IExtenderProvider
    {
        ...
        {
            AnimationType = ZeroitDevColorPicker.Helpers.Animations.AnimationType.VertSlide;
        ...
        private void InitDefaultAnimation(ZeroitDevColorPicker.Helpers.Animations.AnimationType animationType)
        {
