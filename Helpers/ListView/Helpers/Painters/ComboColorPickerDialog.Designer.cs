namespace ZeroitDevColorPicker.Helpers.Editors
{
    partial class ComboColorPickerDialog
    {
        ...
        {
            this.comboColorPicker = new ZeroitDevColorPicker.Helpers.Editors.ComboColorPicker();
            this.SuspendLayout();
            // 
            // comboColorPicker
            // 
            ...
            this.comboColorPicker.ColorSelected += new ZeroitDevColorPicker.Helpers.Editors.BaseColorPicker.ColorSelectedEventHandler(this.comboColorPicker_ColorSelected);
            // 
