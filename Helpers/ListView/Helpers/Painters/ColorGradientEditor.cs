...
namespace ZeroitDevColorPicker.Helpers.Editors
{
    ...
    public partial class ColorGradientEditor : UserControl
    {
        ...
        {
            ZeroitDevColorPicker.Helpers.Editors.ComboColorPickerDialog d = new ZeroitDevColorPicker.Helpers.Editors.ComboColorPickerDialog(colorLabel.BackColor, colorButton);
